...
| 구분 | 주 기능            | 상세 기능                          | 설명                                                                 | 우선순위 | 프론트엔드 | 백엔드 |
|------|--------------------|-----------------------------------|----------------------------------------------------------------------|----------|------------|--------|
| 1. 회원   | 1.1 회원가입      | 1.1.1 회원가입                   | ID, PW, 이메일, 이름, 전화번호를 입력하여 회원가입 가능                  | 1        | 진척 여부 확인 | 완료   |
|      | 1.2 로그인          | 1.2.1 로그인                     | ID, PW를 입력하여 로그인 가능                                         | 1        | 진척 여부 확인 | 완료   |
|      | 1.3 SNS 로그인      | 1.3.1 Kakao OAuth                | Kakao API를 활용한 로그인                                            | 1        | 진척 여부 확인 | 완료   |
|      | 1.4 마이페이지      | 1.4.1 마이페이지                 | 닉네임, 소개글, 비밀번호 수정 및 탈퇴 가능                             | 1        | 진척 여부 확인 | 완료   |
|      | 1.5 유저정보 관리   | 1.5.1 유저정보 관리              | 키, 몸무게 입력 및 미입력 사용자에게 알림                              | 1        | 진척 여부 확인 | 완료   |
| 2. 채팅   | 2.1 회원간 1:1 채팅 | 2.1.1 채팅 신청                  | 게시글에 댓글을 단 사용자 간 채팅 가능                                 | 2        | 진행 중     | 진행 중 |
|      |                    | 2.1.2 채팅방 목록                | 채팅 중인 히스토리 표시                                               | 2        | 진행 중     | 진행 중 |
|      |                    | 2.1.3 채팅방                     | 채팅 프로필 사진, 대화 시간 표시 및 이전 히스토리 제공                 | 2        | 진행 중     | 진행 중 |
| 3. 운동 기록 | 3.1 근력 운동      | 3.1.1 근력 운동 횟수             | 세부 운동별 진행 횟수 작성 가능                                       | 1        | 완료        | 완료   |
|      |                    | 3.1.2 전체 운동 시간             | 운동별 기록 시간 합산 표시                                            | 1        | 완료        | 완료   |
|      |                    | 3.1.3 근력 운동 쉬는 시간        | 중간 휴식 시간 기록 가능                                              | 2        | 완료        | 완료   |
|      | 3.2 유산소 운동     | 3.2.1 유산소 운동 시간 기록       | 세부 운동 시간 기록 가능                                              | 1        | 완료        | 완료   |
